...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
				...
				if ($.type(element) === "object") {
					...
					if (isQuery(element)) {
						obj = {
							...
							title   : element.data('fancybox-title') || element.attr('title') || element.attr('fancybox-title'),
							isDom   : true,
							element : element
						};
		...
		bindEvents: function () {
			...
			if ($n.mousewheel && current.mouseWheel) {
		...
		_setDimension: function () {
			...
			wrap.add(skin).add(inner).width('auto').height('auto').removeClass('fancybox-t');
		...
		_afterZoomIn: function () {
			...
			if (current.closeBtn) {
				$(current.tpl.closeBtn).appendTo(F.skin).bind( isTouch ? 'touchstart.fb' : 'click.fb', function(e) {
					e.preventDefault();
					if (document.getElementById("fancybox_video") != null) document.getElementById("fancybox_video").pause();
					F.close();
				});
			}
