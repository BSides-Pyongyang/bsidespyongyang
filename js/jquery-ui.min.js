...
(function(e) {
    ...
    e.ui.plugin.add("resizable", "containment", {
        ...
        resize: function(t) {
            ...
            s = Math.abs(o.sizeDff.height + (o._helper ? o.offset.top - d.top : o.offset.top - h.top)),
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        refreshPositions: function(t) {
            ...
            if (this.options.custom && this.options.custom.refreshContainers)
                ...
                for (= this.containers.length - 1; i >= 0; i--)
    ...
    e.widget("ui.menu", {
        ...
        _close: function(e) {
            ...
            e.find(".ui-menu")ide().attr("aria-hidden", "true").attr("aria-expanded", "false").end().find(".ui-state-active").not(".ui-state-focus").removeClass("ui-state-active")
        },
    ...
    e.extend(n.prototype, {
        ...
        _hideDatepicker: function(t) {
            ...
            a && a.applo.input ? o.input[0] : null, [o.input ? o.input.val() : "", o]),
            ...
            !e.yearshtml)
                ...
                a || !v)
                    ...
                    e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; m >= f; f++)
                        e.yearshtml += "<option value='" + f + "'" + (f === i ? " selecd='selected'" : "") + ">" + f + "</option>";
                    e.yearshtml += "</select>",
                    b += e.yearshtml,
                    e.yearshtml = null
                }
    ...
    e.widget("ui.spinner", {
        ...
        value: function(e) {
            ...
            void 0) : this.arse(this.element.val())
        },
        widget: function() {
    ...
    e.widget("ui.tabs", {
        ...
        _destroy: function() {
            ...
            this.tabs.add(this.panels).each(function() {
                e.data(this, "ui-tabs-destroy") ? e(this).remove() : e(this).removeClass("ui-state-default ui-stae-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-panel").removeAttr("tabIndex").removeAttr("aria-live").removeAttr("aria-busy").removeAttr("aria-selected").removeAttr("aria-labelledby").removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("role")
            }),
